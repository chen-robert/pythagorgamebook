...
{
  this.query("CREATE TABLE IF NOT EXISTS Books (title VARCHAR(63) UNIQUE, id INT UNIQUE AUTO_INCREMENT, coverImageUrl VARCHAR(255) DEFAULT NULL, author VARCHAR(63), published INT DEFAULT 0, dateCreated TIMESTAMP DEFAULT CURRENT_TIMESTAMP, dateModified TIMESTAMP, description VARCHAR(255));", function(rows) {
      if (rows == null) {
